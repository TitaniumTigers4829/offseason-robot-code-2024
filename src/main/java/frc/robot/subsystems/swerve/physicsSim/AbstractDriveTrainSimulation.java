...
/**
 * Simulates an abstract drivetrain in the simulation world.
 *
 * <p>Simulates the mass, collision space and other physical properties of the drivetrain.
 *
 * <p>Simulates the friction forces of the drivetrain.
 *
 * <p>Propelling forces of the motors are simulated in other classes, such as {@link
...
public abstract class AbstractDriveTrainSimulation extends Body {
  ...
  /**
   * sets the robot's current pose in the simulation world the robot DOES NOT drive to that pose, it
  ...
  /**
   * Abstract simulation periodic method. Called everytime the simulation world is updated. The
   * robot should apply the propelling forces here.
   */
  public abstract void simulationSubTick();

  /**
   * simulate the LINEAR friction force on the drivetrain when the drivetrain is not trying to move
   * LINEARLY
   */
  ...
  /**
   * simulate the ANGULAR friction force on the drivetrain when the drivetrain is not trying to move
   * ROTATIONALLY
   */
  protected void simulateChassisAngularFriction() {
    ...
    else /* when the velocity is too small, just set it still */ super.setAngularVelocity(0);
  }
