 ...
 *
 * <p>Made up of more than two {@link SwerveModuleSimulation}
 *
 * <h3>To Simulate Odometry: </h3>
 *
 * <p>1. Retrieve the encoder readings from {@link SwerveModuleSimulation}.
 *
 * <p>2. Use a {@link edu.wpi.first.math.kinematics.SwerveDriveOdometry} to estimate the pose of
 * your robot. <a
 * href="https://v6.docs.ctr-electronics.com/en/latest/docs/application-notes/update-frequency-impact.html">250HZ
 * Odometry</a> IS SUPPORTED
 *
 * <p>3. Optionally, obtain real robot pose from {@link
 * AbstractDriveTrainSimulation}.getSimulatedDriveTrainPose() and feed it to <a
 * href="https://docs.photonvision.org/en/latest/docs/simulation/simulation-java.html#updating-the-simulation-world">photon
 * vision simulation</a> to simulate vision
 *
 * <p>this way, you get a realistic simulation of the odometry, which accounts for measurement
 * errors due to skidding and imu drifting.
 */
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
  ...
  public SwerveDriveSimulation(
    ...
    super(
        new DriveTrainSimulationProfile(
                ...
                bumperWidthMeters,
                bumperLengthMeters)
            .withAngularVelocityDamping(1)
            .withLinearVelocityDamping(1),
        initialPoseOnField);
  ...
  private void simulateChassisFrictionForce() {
    final ChassisSpeeds differenceBetweenFloorSpeedAndModuleSpeedsRobotRelative =
        getModuleSpeeds().minus(getDriveTrainSimulatedChassisSpeedsRobotRelative());
    ...
    SmartDashboard.putString(
        "MapleArenaSimulation/difference", floorAndModuleSpeedsDiffFieldRelative.toString());
