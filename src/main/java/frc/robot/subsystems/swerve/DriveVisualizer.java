...
//             moduleMechanisms[0].getRoot("RootSpeed", 0.5, 0.5).append(new
// MechanismLigament2d("Speed", 0.5, 0)),
//             moduleMechanisms[1].getRoot("RootSpeed", 0.5, 0.5).append(new
// MechanismLigament2d("Speed", 0.5, 0)),
//             moduleMechanisms[2].getRoot("RootSpeed", 0.5, 0.5).append(new
// MechanismLigament2d("Speed", 0.5, 0)),
//             moduleMechanisms[3].getRoot("RootSpeed", 0.5, 0.5).append(new
// MechanismLigament2d("Speed", 0.5, 0)),
//     };
...
//     public void telemeterize(SwerveModuleState state) {
