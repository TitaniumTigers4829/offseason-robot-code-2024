...
public class SwerveDrive extends SubsystemBase implements HolonomicDriveSubsystem {
    ...
    public SwerveDrive(GyroIO gyroIO, ModuleIO frontLeftModuleIO, ModuleIO frontRightModuleIO, ModuleIO backLeftModuleIO, ModuleIO backRightModuleIO) {
        ...
        this.poseEstimator = new SwerveDrivePoseEstimator(
                ...
                VecBuilder.fill(DriveConstants.X_POS_TRUST, DriveConstants.Y_POS_TRUST, DriveConstants.ANGLE_TRUST),
                VecBuilder.fill(VisionConstants.VISION_X_POS_TRUST, VisionConstants.VISION_Y_POS_TRUST, VisionConstants.VISION_ANGLE_TRUST)
        );
    ...
    @Override public double getChassisMaxLinearVelocityMetersPerSec() {return 4.5;}
