...
public class IntakeIOSim implements IntakeIO{
  ...
  private final ProfiledPIDController pivotController =
    ...
    public void setPivotPosition(double position) {
        pivotSim.setInputVoltage(pivotController.calculate(position, pivotSim.getAngleRads() / (Math.PI * 2)) + pivotFF.calculate(pivotController.getSetpoint().position, pivotController.getSetpoint().velocity));
    }
