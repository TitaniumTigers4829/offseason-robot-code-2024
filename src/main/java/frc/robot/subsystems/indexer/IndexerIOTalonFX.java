...
public class IndexerIOTalonFX implements IndexerIO {
    ...
    public IndexerIOTalonFX() {
        ...
        indexerConfiguration.MotorOutput.DutyCycleNeutralDeadband = HardwareConstants.MIN_FALCON_DEADBAND;
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(100, indexerVelocity, indexerAppliedVolts, indexerStatorCurrentAmps, indexerSupplyCurrentAmps, indexerTemp);
    ...
    public void updateInputs(IndexerIOInputs inputs) {
        ...
        inputs.isConnected = BaseStatusSignal.isAllGood(indexerVelocity, indexerAppliedVolts, indexerStatorCurrentAmps, indexerSupplyCurrentAmps, indexerTemp);
    }
