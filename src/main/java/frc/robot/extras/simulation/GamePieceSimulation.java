...
public class GamePieceSimulation extends Body {
    ...
    public GamePieceSimulation(String type, Convex shape, double height, double mass, Translation2d initialPosition) {
        super();
        this.type = type;
        this.height = height;
    ...
    public void setVelocity(ChassisSpeeds chassisSpeedsWorldFrame) {
        super.setLinearVelocity(
                GeomUtil.toDyn4jLinearVelocity(chassisSpeedsWorldFrame)
        );
