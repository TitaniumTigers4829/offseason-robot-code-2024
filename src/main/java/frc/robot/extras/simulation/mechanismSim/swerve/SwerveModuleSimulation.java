 ...
 *       {@link #getCachedDriveEncoderUnGearedPositionsRad()} and {@link #getCachedTurnAbsolutePositions()}.
 * </ul>
 *
...
public class SwerveModuleSimulation {
    ...
    private final Queue<Double> cachedTurnRelativeEncoderPositionsRad, cachedDriveEncoderUnGearedPositionsRad;
     ...
     *
     * <p>If you are using {@link SimulatedField#overrideSimulationTimings(double, int)} to use custom timings, you must
     ...
     * @param turnFrictionVoltage the measured minimum amount of voltage that can turn the steering rotter, in volts
    ...
    public SwerveModuleSimulation(
        ...
        this.turnMotorSim = new BrushlessMotorSim(
        ...
        this.turnRelativeEncoderPositionRad = turnAbsolutePosition.getRadians() + turnRelativeEncoderOffSet;
    }
     ...
     * behavior.
     *
     * <p>To check the actual voltage applied to the steering motor, use {@link #getTurnMotorAppliedVolts()}.
     *
     ...
     * {@link BrushlessMotorSim#getAppliedVolts()} method.
     *
     * <p>The actual applied voltage may differ from the value set by {@link #requestTurnVoltageOut(double)}. If the
     ...
     *
     * <p>The values of {@link #getTurnRelativeEncoderPositionRad()} are cached at each sub-tick and can be retrieved
     * using this method.
     *
     * @return an array of cached steer relative encoder positions, in radians
     */
    public double[] getCachedTurnRelativeEncoderPositions() {
        return cachedTurnRelativeEncoderPositionsRad.stream()
                .mapToDouble(value -> value)
                .toArray();
    }
     ...
     *
     * <p>The values of {@link #getTurnAbsolutePosition()} are cached at each sub-tick and can be retrieved using this
     * method.
     *
    ...
    private void updateTurnSimulation() {
        ...
        this.turnRelativeEncoderPositionRad = turnMotorSim.getPosition().in(Radians) + turnRelativeEncoderOffSet;
     ...
     * current limit through {@link BrushlessMotorSim#constrainOutputVoltage(DCMotor, double, double, double)}.
     *
    ...
    public SwerveModuleState getCurrentState() {
        return new SwerveModuleState(getDriveWheelFinalSpeedRadPerSec() * WHEEL_RADIUS_METERS, turnAbsolutePosition);
    }
