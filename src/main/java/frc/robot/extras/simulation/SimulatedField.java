...
public abstract class SimulatedField {
  ...
  public static final double SIMULATION_DT =
      0.02 / SIMULATION_SUB_TICKS_IN_1_PERIOD; // Default timed robot period divided by simulation
  // ticks
  ...
  /**
   * register a runnable action that is called in every simulation sub-tick
   *
   * <p>FOR TESTING ONLY
   */
  @Deprecated
  ...
  public void simulationPeriodic() {
    ...
    SmartDashboard.putNumber(
        "MapleArenaSimulation/Dyn4j Simulator CPU Time MS", (System.nanoTime() - t0) / 1000000.0);
  }
