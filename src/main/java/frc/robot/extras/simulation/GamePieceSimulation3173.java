...
public class GamePieceSimulation3173 {
    private static final Translation2d[] AUTO_NOTES = {
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.175, 7.0),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.175, 5.54),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.175, 4.1),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.825, 7.0),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.825, 5.54),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS * 0.825, 4.1),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS / 2.0, 7.44),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS / 2.0, 5.77),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS / 2.0, 4.11),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS / 2.0, 2.42),
        new Translation2d(FieldConstants.FIELD_LENGTH_METERS / 2.0, 0.76),
    };
        ...
        Command teleopCmd = new FunctionalCommand(
                () -> {
                    ...
                    notes.addAll(List.of(TELEOP_NOTES)
                        .stream()
                        .map(t -> AllianceFlipper.isBlue() ? t : AllianceFlipper.flipTranslation(t))
                        .toList()
                    );
                    noteDisplayFunction.accept(notes);
                },
