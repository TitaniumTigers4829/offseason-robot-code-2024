...
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
    ...
    private void simulateChassisFrictionForce() {
        ...
        final Rotation2d dTheta = GeomUtil.getChassisSpeedsTranslationalComponent(moduleSpeedsFieldRelative)
                .getAngle()
        ...
        previousModuleSpeedsFieldRelative = GeomUtil.getChassisSpeedsTranslationalComponent(moduleSpeedsFieldRelative);
