...
public abstract class IntakeSimulation extends BodyFixture {
     ...
     */
    public IntakeSimulation(SimulatedField arena, AbstractDriveTrainSimulation driveTrainSimulation, double width, IntakeSide side, int capacity) {
        this(
                arena,
     ...
     * @param capacity              the amount of game-pieces that can be hold in the intake
     */
    public IntakeSimulation(SimulatedField arena, AbstractDriveTrainSimulation driveTrainSimulation, Translation2d startPointOnRobot, Translation2d endPointOnRobot, int capacity) {
        this(
                arena,
                driveTrainSimulation,
                new Segment(GeomUtil.toDyn4jVector2(startPointOnRobot), GeomUtil.toDyn4jVector2(endPointOnRobot)),
                capacity
        );
    }
     ...
     * @param capacity              the amount of game-pieces that can be hold in the intake\
     */
    public IntakeSimulation(SimulatedField arena, AbstractDriveTrainSimulation driveTrainSimulation, Convex shape, int capacity) {
        super(shape);
        if (capacity > 100)
